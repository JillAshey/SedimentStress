...
```{r}
# just playing 
rnapower(10, cv = 0.4, effect = c(1.25, 1.5, 1.75, 2), alpha = 0.5, power = c(0.8, 0.9))
```
Calculate coefficient of variation in gene count matrix (should I do filtered or unfiltered counts?)
...
mean(df) # 0.4229508 -- avg cv for T1-4
```
