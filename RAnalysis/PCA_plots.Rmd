...
Make PCA plots for each species and merge them together for manuscript figure. 
...
p1
ggsave("../Output/Figs/PCA/PCA_FL.png", p1, width = 15, height = 5)
ggsave("../Output/Figs/PCA/PCA_FL.pdf", p1, width = 15, height = 5)
```
...
p2
ggsave("../Output/Figs/PCA/PCA_HI.png", p2, width = 15, height = 5)
ggsave("../Output/Figs/PCA/PCA_HI.pdf", p2, width = 15, height = 5)
```
...
full
ggsave("../Output/Figs/PCA/PCA_all.png", full, width = 15, height = 10)
ggsave("../Output/Figs/PCA/PCA_all.pdf", full, width = 15, height = 10)
```
