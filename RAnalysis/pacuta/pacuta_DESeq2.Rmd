...
countdata_merge <- read.csv("../../Output/DESeq2/pacuta/gene_count_pacuta_matrix_merge.csv")
gtf <- read.csv(file="~/Desktop/GFFs/pacuta/stringtie_pacuta_merged.gtf", header=FALSE, sep="\t", skip = 2) 
...
pacuta_heatmap <- pheatmap(sampleDistMatrix, # plot matrix
...
pacuta_PCAplot <- ggplot(vst_PCAdata, aes(PC1, PC2, color=Treatment, shape =Days)) + 
   geom_point(size=3) +
...
pacuta_PCAplot # there is no clear grouping of Days, so I will not be moving forward with Treatment only as an independent variable in my analysis 

# save plots 
pacuta_heatmap_PCA <- grid.arrange(pacuta_PCAplot, pacuta_heatmap[[4]], nrow=1, ncol = 2, clip="off")
#ggsave("Output/Figs/pacuta/pacuta_heatmap_PCA_AllGenes_20220520.jpeg", pacuta_heatmap_PCA, width = 20, height = 25, units = "cm")
#ggsave("Output/Figs/pacuta/pacuta_heatmap_PCA_AllGenes_20220520.pdf", pacuta_heatmap_PCA, width = 20, height = 25, units = "cm")
```
...
ggsave("../../Output/Figs/pacuta/pacuta_DEGs_PCA_20230906.jpeg", pacuta_DEGPCAplot, width = 20, height = 20, units = "cm")
ggsave("../../Output/Figs/pacuta/pacuta_DEGs_PCA_20230906.pdf", pacuta_DEGPCAplot, width = 20, height = 20, units = "cm")
```
