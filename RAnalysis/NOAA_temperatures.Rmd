...
```{r}
FP_temp_sub <- FP_temp %>% 
  filter(Date.Time > as.POSIXct("2016-05-23 00:03:00"), Date.Time < as.POSIXct("2016-06-15 23:00:00"))
```
...
```{r}
temps <- plot_grid(FL_plot, HI_plot, nrow = 2)

ggsave("Output/Figs/Temperature/FL_HI_Temperatures.png", temps, width = 15, height = 10)
```
