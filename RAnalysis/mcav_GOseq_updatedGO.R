...
# Load DEGs
DEG_mcav <- read.csv("~/Desktop/PutnamLab/Repositories/SedimentStress/SedimentStress/Output/DESeq2/mcav/mcav_unique.sig.list.csv", header = TRUE)
...
write.csv(GO.wall, file = "~/Desktop/mcav_GO_ALL_20210125.csv")
...
DEG_treatment <- read.csv("~/Desktop/PutnamLab/Repositories/SedimentStress/SedimentStress/Output/DESeq2/mcav/mcav_DEGs.all_treatment.csv", header = TRUE)
...
write.csv(MF_ByTreatment, file = "~/Desktop/mcav_MF_Sig_Enriched_ByTreatment_GO.05_20210125.csv")
write.csv(CC_ByTreatment, file = "~/Desktop/mcav_CC_Sig_Enriched_ByTreatment_GO.05_20210125.csv")
write.csv(BP_ByTreatment, file = "~/Desktop/mcav_BP_Sig_Enriched_ByTreatment_GO.05_20210125.csv")
write.csv(ByTreatment_GO.terms, file = "~/Desktop/mcav_ByTreatment_GO.terms_20210125.csv")
...
ggsave("~/Desktop/mcav_GOplot_05_20210125.pdf", GOplot, width = 21, height = 21, units = c("in"))
...
GOplot2
ggsave("~/Desktop/mcav_GOplot2_05_20210125.pdf", GOplot2, width = 28, height = 28, units = c("in"))
...
GOplot_pvalue <- enriched.GO.05 %>% drop_na(ontology) %>% mutate(term = fct_reorder(term, over_represented_pvalue)) %>%
  ...
  theme(panel.border = element_blank(), # Set border
        ...
        plot.background=element_blank()) #Set the plot background #set title attributes
GOplot_pvalue
ggsave("~/Desktop/mcav_GOplot_pvalue_05_20210125.pdf", GOplot_pvalue, width = 28, height = 28, units = c("in"))
