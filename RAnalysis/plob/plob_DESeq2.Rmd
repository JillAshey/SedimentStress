...
#### Code for Francois sedimentation data. Plob only samples analyzed here aligned against Plob STAR was read aligner and Plob genomic info can be found [here](http://plut.reefgenomics.org/download/)
...
countdata <- read.csv("../../Output/DESeq2/plob/plob_gene_count_matrix.csv")
...
## Load metadata
```{r}
metadata_plob <- read.csv("../../Data/plob_metadata_raw_filtered.csv")
...
plob_heatmap <- pheatmap(sampleDistMatrix, # plot matrix
...
plob_PCAplot <- ggplot(vst_PCAdata, aes(PC1, PC2, color=Treatment, shape =Days)) + 
   geom_point(size=3) +
...
plob_PCAplot # there is no clear grouping of Days, so I will not be moving forward with Treatment only as an independent variable in my analysis 

# save plots 
plob_heatmap_PCA <- grid.arrange(plob_PCAplot, plob_heatmap[[4]], nrow=1, ncol = 2, clip="off")
#ggsave("Output/Figs/plob/plob_heatmap_PCA_AllGenes_20220520.jpeg", plob_heatmap_PCA, width = 20, height = 25, units = "cm")
#ggsave("Output/Figs/plob/plob_heatmap_PCA_AllGenes_20220520.pdf", plob_heatmap_PCA, width = 20, height = 25, units = "cm")
```
...
ggsave("../../Output/Figs/plob/plob_DEGs_PCA_20230906.jpeg", plob_DEGPCAplot, width = 20, height = 25, units = "cm")
ggsave("../../Output/Figs/plob/plob_DEGs_PCA_20230906.pdf", plob_DEGPCAplot, width = 20, height = 25, units = "cm")
```
