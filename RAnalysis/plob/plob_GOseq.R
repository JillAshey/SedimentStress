...
write.csv(GO.wall, file = "~/Desktop/plob_GO_ALL_20210326.csv")
...
write.csv(MF, file = "~/Desktop/plob_MF_Sig_Enriched_GO.05_20210326.csv")
write.csv(CC, file = "~/Desktop/plob_CC_Sig_Enriched_GO.05_20210326.csv")
write.csv(BP, file = "~/Desktop/plob_BP_Sig_Enriched_GO.05_20210326.csv")
write.csv(enriched.GO.05, file = "~/Desktop/plob_Sig_Enriched_GO.05_ALL_20210326.csv")
...
DEG_treatment <- read.csv("~/Desktop/plob_DEGs.all_treatment_20210326.csv", header = TRUE)
...
ggsave("~/Desktop/plob_GOplot_05_20210326.pdf", GOplot, width = 21, height = 21, units = c("in"))
...
GOplot2_pvalue
ggsave("~/Desktop/plob_GOplot2_pvalue_05_20210326.pdf", GOplot2_pvalue, width = 28, height = 28, units = c("in"))
