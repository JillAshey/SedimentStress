...
gcounts_filt_acerv <- read.csv("~/Desktop/acerv_counts_filtered.csv", header = TRUE)
...
DEG_acerv <- read.csv("~/Desktop/acerv_unique.sig.list.csv", header = TRUE)
...
# Import GO term
annot_GO <- read.csv("~/Desktop/acerv_GOterms.csv", header=TRUE)
