...
upset_go.all <- upset(
  go,
  c("Acervicornis", "Mcavernosa", "Ofaveolata", "Mcapitata", "Pacuta", "Plobata"),
  queries=list(
    upset_query(set='Acervicornis', fill='chartreuse3'),
    upset_query(set='Mcavernosa', fill='chartreuse3'),
    upset_query(set='Ofaveolata', fill='chartreuse3'),
    upset_query(set='Mcapitata', fill='chocolate2'),
    upset_query(set='Pacuta', fill='chocolate2'),
    upset_query(set='Plobata', fill='chocolate2')
  ),
  base_annotations=list(
    'Intersection size'=(
        intersection_size(
        bar_number_threshold=5,  # show all numbers on top of bars
  ...
  set_sizes=(
    upset_set_size(geom=geom_bar(width=0.4, color = "black", fill = "black"))
    + theme(
...
#upset_go.all
ggsave("Output/Figs/upset/upset_all_GO_20221125.pdf", upset_go.all, width = 40, height = 20, units = c("in"))
ggsave("Output/Figs/upset/upset_all_GO_20221125.png", upset_go.all, width = 40, height = 20, units = c("in"))
...
upset_go.bp <- upset(
  ...
  stripes=upset_stripes(
    geom=geom_segment(size=12),  # make the stripes larger
    # REMEMBER to check color order for all species
...
upset_go.bp
ggsave("Output/Figs/upset/upset_GO.BP_20221125.pdf", upset_go.bp, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.BP_20221125.png", upset_go.bp, width = 40, height = 40, units = c("in"))
...
#upset_go.cc
ggsave("Output/Figs/upset/upset_GO.CC_20221125.pdf", upset_go.cc, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.CC_20221125.png", upset_go.cc, width = 40, height = 40, units = c("in"))
...
#upset_go.mf
ggsave("Output/Figs/upset/upset_GO.MF_20221125.pdf", upset_go.mf, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.MF_20221125.png", upset_go.mf, width = 40, height = 40, units = c("in"))
```

This is different code than what I used in the Orthogroup upset [plots](https://github.com/JillAshey/SedimentStress/blob/master/RAnalysis/Orthogroups.Rmd). As I move forward, I'll assess which version of the code is better/easier to work with. 
...
count_location_plot
#ggsave("Output/Figs/GOslim/BP/LocationsCounts_GOslim.BP_20220417.pdf", count_location_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/BP/LocationsCounts_GOslim.BP_20220417.png", count_location_plot, width = 49, height = 40, units = c("in"))
...
all.go.BP.slim <- all.go.BP.slim %>% mutate(Morphology = 
                                              case_when(Species == "A.cervicornis" ~ "Branching", 
                                                        ...
                                                        Species == "M.capitata" ~ "Intermediate", # branching or intermediate?
...
count_morph_plot
#ggsave("Output/Figs/GOslim/BP/MorphologyCounts_GOslim.BP_20220417.pdf", count_morph_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/BP/MorphologyCounts_GOslim.BP_20220417.png", count_morph_plot, width = 49, height = 40, units = c("in"))
```
...
count_location_plot <- ggplot(count_by_location, aes(fill = Location, y = n, x = GO.Slim.Term)) +
  ...
  theme(legend.title = element_text(size = 80), 
        ...
        scale_fill_manual(values = c("chartreuse3", "chocolate2"))
count_location_plot
#ggsave("Output/Figs/GOslim/CC/LocationsCounts_GOslim.CC_20220417.pdf", count_location_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/CC/LocationsCounts_GOslim.CC_20220417.png", count_location_plot, width = 49, height = 40, units = c("in"))
...
count_morph_plot
#ggsave("Output/Figs/GOslim/CC/MorphologyCounts_GOslim.CC_20220417.pdf", count_morph_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/CC/MorphologyCounts_GOslim.CC_20220417.png", count_morph_plot, width = 49, height = 40, units = c("in"))
```
...
count_location_plot <- ggplot(count_by_location, aes(fill = Location, y = n, x = GO.Slim.Term)) +
  ...
  theme(legend.title = element_text(size = 80), 
        ...
        scale_fill_manual(values = c("chartreuse3", "chocolate2"))
count_location_plot
#ggsave("Output/Figs/GOslim/MF/LocationsCounts_GOslim.MF_20220417.pdf", count_location_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/MF/LocationsCounts_GOslim.MF_20220417.png", count_location_plot, width = 49, height = 40, units = c("in"))
...
count_morph_plot <- ggplot(count_by_morph, aes(fill = Morphology, y = n, x = GO.Slim.Term)) +
  ...
  theme(legend.title = element_text(size = 80), 
        ...
        scale_fill_manual(values = c("paleturquoise3", "rosybrown2"))
count_morph_plot
#ggsave("Output/Figs/GOslim/MF/MorphologyCounts_GOslim.MF_20220417.pdf", count_morph_plot, width = 49, height = 40, units = c("in"))
#ggsave("Output/Figs/GOslim/MF/MorphologyCounts_GOslim.MF_20220417.png", count_morph_plot, width = 49, height = 40, units = c("in"))
```
