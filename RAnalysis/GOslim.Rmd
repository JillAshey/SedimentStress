...
upset_all <- upset(
    ...
    matrix=(
        ...
        + scale_color_manual(
            values=c('Acervicornis'='green', 'Mcavernosa'='green', 'Ofaveolata'='green', 'Mcapitata'='orange', 'Pacuta'='orange', 'Plobata'='orange'),
            guide=guide_legend(override.aes=list(shape='circle'))
        )
    ),
    queries=list(
        upset_query(set='Acervicornis', fill='green'),
        upset_query(set='Mcavernosa', fill='green'),
        upset_query(set='Ofaveolata', fill='green'),
        upset_query(set='Mcapitata', fill='orange'),
        upset_query(set='Pacuta', fill='orange'),
        upset_query(set='Plobata', fill='orange')
    )
)
upset_all
ggsave("Output/Figs/upset/upset_all_GO_20221125.pdf", upset_all, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_all_GO_20221125.png", upset_all, width = 40, height = 40, units = c("in"))
...
upset_BP
ggsave("Output/Figs/upset/upset_GO.BP_20221125.pdf", upset_BP, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.BP_20221125.png", upset_BP, width = 40, height = 40, units = c("in"))
...
upset_CC
ggsave("Output/Figs/upset/upset_GO.CC_20221125.pdf", upset_CC, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.CC_20221125.png", upset_CC, width = 40, height = 40, units = c("in"))
...
upset_MF
ggsave("Output/Figs/upset/upset_GO.MF_20221125.pdf", upset_MF, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_GO.MF_20221125.png", upset_MF, width = 40, height = 40, units = c("in"))


## I think there are duplicates or something in the dataset so the values on the plots are inflated. When I join the datasets, sometimes there is a gene that has many GO IDs and it gets 'joined' w/ a gene that is only attached to one of those GO IDs from another species. 
## Do I care about # of genes? no, just # of GO terms??
```
