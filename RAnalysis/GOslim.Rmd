...
upset_go.all <- upset(
  ...
  stripes=upset_stripes(
    ...
    colors=c("#0066CC", # Pacuta - branching      REMEMBER to check color order for all species
...
#upset_go.all
ggsave("Output/Figs/upset/upset_all_GO_20221125.pdf", upset_go.all, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_all_GO_20221125.png", upset_go.all, width = 40, height = 40, units = c("in"))
...
upset_go.bp <- upset(
  ...
  stripes=upset_stripes(
    ...
    colors=c("#0066CC", # Pacuta - branching  
              "#0066CC", # Acerv - branching 
             "#E4E408",  # Plobata - massive
              "#A0A0A0", # Mcap - intermediate
              "#E4E408",  # Mcav - massive 
