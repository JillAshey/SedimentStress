...
count_location_plot <- ggplot(count_by_location, aes(fill = Location, y = n, x = GO.Slim.Term)) +
  ...
  #           size = 10, 
  #           face = "bold") +
  labs(title="Counts of GO Slim Categories by Location", x ="", y = "Counts") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 65, 
                                   #vjust = 0.5, 
                                   hjust= 1, 
...
count_location_plot
ggsave("Output/Figs/LocationsCounts_GOslim.BP_20220324.pdf", count_location_plot, width = 40, height = 30, units = c("in"))
ggsave("Output/Figs/LocationsCounts_GOslim.BP_20220324.png", count_location_plot, width = 40, height = 30, units = c("in"))
...
count_morph_plot <- ggplot(count_by_morph, aes(fill = Morphology, y = n, x = GO.Slim.Term)) +
  ...
  #           size = 10, 
  #           face = "bold") +
  labs(title="Counts of GO Slim Categories by Morphology", x ="", y = "Counts") +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 65, 
                                   #vjust = 0.5, 
                                   hjust= 1, 
...
count_morph_plot
ggsave("Output/Figs/MorphologyCounts_GOslim.BP_20220324.pdf", count_morph_plot, width = 40, height = 30, units = c("in"))
ggsave("Output/Figs/MorphologyCounts_GOslim.BP_20220324.png", count_morph_plot, width = 40, height = 30, units = c("in"))
```
