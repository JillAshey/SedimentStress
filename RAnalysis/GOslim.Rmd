...
GO.ofav <- ggplot(Gene.GO.IDs.slims.ofav.BP, aes(x = ontology, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.ofav
#ggsave("Output/Figs/ofav/ofav_GOslim.BP_20220111.pdf", GO.ofav, width = 28, height = 28, units = c("in"))
```
...
write.csv(all.go.slim, "Output/GOSeq/all.go.slim_20220119.csv")

# Subset Biological Processes (BP) 
all.go.slim.BP <- subset(all.go.slim, ontology == "BP")
write.csv(all.go.slim.BP, "Output/GOSeq/all.go.slim.BP_20220119.csv")
...
GO.all
ggsave("Output/Figs/all_GOslim.BP_20220119.pdf", GO.all, width = 40, height = 40, units = c("in"))
```
...
Look at all_GOslim.BP plot to see which GOslim term has the most associated GO terms. Then, plot by that GOslim term. Going to subset and plot: cell organization and biogenesis, developmental processes, other biological processes, other metabolic processes, protein metabolism, RNA metabolism, signal transduction, stress response, & transport 
...
GO.CCS.subset <- ggplot(go.slim.CCS.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.CCS.subset
ggsave("Output/Figs/CCS.Subset_GOslim.BP_20220111.pdf", GO.CCS.subset, width = 40, height = 40, units = c("in"))
```
...
GO.COB.subset <- ggplot(go.slim.COB.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.COB.subset
ggsave("Output/Figs/COB.Subset_GOslim.BP_20220111.pdf", GO.COB.subset, width = 40, height = 40, units = c("in"))
```
...
GO.DP.subset <- ggplot(go.slim.DP.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.DP.subset
ggsave("Output/Figs/DP.Subset_GOslim.BP_20220111.pdf", GO.DP.subset, width = 40, height = 40, units = c("in"))
```
...
GO.OBP.subset <- ggplot(go.slim.OBP.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.OBP.subset
ggsave("Output/Figs/OBP.Subset_GOslim.BP_20220111.pdf", GO.OBP.subset, width = 40, height = 40, units = c("in"))
```
...
GO.OMP.subset <- ggplot(go.slim.OMP.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.OMP.subset
ggsave("Output/Figs/OMP.Subset_GOslim.BP_20220111.pdf", GO.OMP.subset, width = 40, height = 40, units = c("in"))
```
...
GO.PM.subset <- ggplot(go.slim.PM.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.PM.subset
ggsave("Output/Figs/PM.Subset_GOslim.BP_20220111.pdf", GO.PM.subset, width = 40, height = 40, units = c("in"))
```
...
GO.RNAM.subset <- ggplot(go.slim.RNAM.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.RNAM.subset
ggsave("Output/Figs/RNAM.Subset_GOslim.BP_20220111.pdf", GO.RNAM.subset, width = 40, height = 40, units = c("in"))
```
...
GO.ST.subset <- ggplot(go.slim.ST.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.ST.subset
ggsave("Output/Figs/ST.Subset_GOslim.BP_20220111.pdf", GO.ST.subset, width = 40, height = 40, units = c("in"))
```
...
GO.SR.subset <- ggplot(go.slim.SR.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.SR.subset
ggsave("Output/Figs/SR.Subset_GOslim.BP_20220111.pdf", GO.SR.subset, width = 40, height = 40, units = c("in"))
```
...
GO.T.subset <- ggplot(go.slim.T.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.T.subset
ggsave("Output/Figs/T.Subset_GOslim.BP_20220111.pdf", GO.T.subset, width = 40, height = 40, units = c("in"))
```
