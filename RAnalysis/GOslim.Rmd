...
```{r}
go.slim.CCS.subset <- all.go.slim.BP %>% filter(GO.Slim.Term=="cell-cell signaling")
...
GO.CCS.subset <- ggplot(go.slim.CCS.subset, aes(x = Species, y = term)) + 
  ...
  theme_bw() + theme(panel.border = element_blank(), panel.grid.major = element_blank(),
                     ...
                     axis.text = element_text(size = 30))
GO.CCS.subset
ggsave("Output/Figs/CCS.Subset_GOslim.BP_20211118.pdf", GO.CCS.subset, width = 40, height = 40, units = c("in"))
```
