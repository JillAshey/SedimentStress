...
all.go.BP.slim <- all.go.BP.slim[!(all.go.BP.slim$GO.Slim.Term == "other biological processes") | (all.go.BP.slim$GO.Slim.Term == "other metabolic processes"),]
...
count
ggsave("Output/Figs/SpeciesCounts_GOslim.BP_20220320.pdf", count, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/SpeciesCounts_GOslim.BP_20220320.png", count, width = 40, height = 40, units = c("in"))
