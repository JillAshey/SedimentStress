...
Make upset plot 
```{r}
## doing example first (https://cran.r-project.org/web/packages/UpSetR/vignettes/basic.usage.html)
...
upset_ortho
ggsave("Output/Figs/upset/upset_ortho_20221125.pdf", upset_ortho, width = 40, height = 40, units = c("in"))
ggsave("Output/Figs/upset/upset_ortho_20221125.png", upset_ortho, width = 40, height = 40, units = c("in"))
```
