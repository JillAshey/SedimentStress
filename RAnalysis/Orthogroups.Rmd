...
length(unique(acerv$Orthogroup)) # 159 orthogroups ? should they be the same?
write.csv(unique(acerv$Orthogroup), "Output/OrthoFinder/acerv_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(acerv, "Output/OrthoFinder/acerv_DEGs_ortho_20220502.csv")
```
...
write.csv(unique(mcav$Orthogroup), "Output/OrthoFinder/mcav_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(mcav, "Output/OrthoFinder/mcav_DEGs_ortho_20220502.csv")
```
...
write.csv(unique(ofav$Orthogroup), "Output/OrthoFinder/ofav_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(ofav, "Output/OrthoFinder/ofav_DEGs_ortho_20220502.csv")
```
...
write.csv(unique(mcap$Orthogroup), "Output/OrthoFinder/mcap_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(mcap, "Output/OrthoFinder/mcap_DEGs_ortho_20220502.csv")
```
...
write.csv(unique(pacuta$Orthogroup), "Output/OrthoFinder/pacuta_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(pacuta, "Output/OrthoFinder/pacuta_DEGs_ortho_20220502.csv")
```
...
write.csv(unique(plob$Orthogroup), "Output/OrthoFinder/plob_uniq_ortho_20220502.csv") ## In Excel, I take the unique ortho files, remove excess rows/cols so its just a list of orthogroups. 

# Write to csv 
write.csv(plob, "Output/OrthoFinder/plob_DEGs_ortho_20220502.csv") 
...
# plotted using this website: https://bioinformatics.psb.ugent.be/cgi-bin/liste/Venn/calculate_venn.htpl. can't figure out how to do it in R
```
