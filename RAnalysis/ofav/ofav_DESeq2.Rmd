...
length(unique(int1)) # 5 genes shared between control_vs_T1 and control_vs_T2'
int2 <- intersect(DEG_control_vs_T1.sig.list_full$gene_id, DEG_control_vs_T3.sig.list_full$gene_id)
length(unique(int2)) # 6 genes shared between control_vs_T1 and control_vs_T3
int3 <- intersect(DEG_control_vs_T1.sig.list_full$gene_id, DEG_control_vs_T4.sig.list_full$gene_id)
length(unique(int3)) # 5 genes shared between control_vs_T1 and control_vs_T4
...
ggsave("Output/Figs/ofav/ofav_DEGs_PCA_20211221.pdf", ofav_DEGPCAplot, width = 25, height = 25, units = "cm")
```
