...
#write.csv(DEG_control_vs_high, file = "~/Desktop/pdam_control_vs_high_all_genes_20210336.csv") # maybe include gene counts too?
...
#write.csv(DEG_mid_vs_high, file = "~/Desktop/pdam_mid_vs_high_all_genes_20210336.csv") # maybe include gene counts too?
...
pdam.volcano <- ggplot(data=pdam.DEG, aes(x=log2FoldChange, y=-log10(padj), col=diffexpressed, shape=Treatment_Compare, label=delabel)) +
 geom_point() +
